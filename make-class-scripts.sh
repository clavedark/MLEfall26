...
build("ex52026answers.qmd", "ex52026answers.R", "Build the Spell Data, Then Model the Hazard -- ANSWER KEY",
      howto=["# HOW TO RUN: open MLEfall26.Rproj FIRST, then this script. Archigos is read",
